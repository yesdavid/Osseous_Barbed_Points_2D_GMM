...
cc <- Momocs::import_jpg(list.files(file.path("2_data", "bases"), 
                                    full.names = T))
...
saveRDS(open_test,
        file = file.path(output_dir, "bases_open_outlines_OpnCoo.RDS"))
# save as list of coordinates
saveRDS(open_test$coo,
        file = file.path(output_dir, "bases_open_outlines_listOfCoords.RDS"))
